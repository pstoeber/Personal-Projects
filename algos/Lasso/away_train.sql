...
inner join(
    ...
    ) as home_team on box_view.game_hash = away_team.game_hash
...
inner join points as opp_team_pts on home_team.team_id = opp_team_pts.team_id and away_team.season -1 = opp_team_pts.season
